      ...
      <div class="card-body">
        ...
        <form action="/questions" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="judul"  placeholder="Masukkan Judul Pertanyaan">
                @error('judul')
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control" name="isi"  placeholder="Apa yang ingin anda tanyakan?"></textarea>
                @error('isi')
                <div class="alert alert-danger">
                    {{ $message }}
                </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-6">
                        ...
                        <select class="form-control" name="kategori" id="" placeholder="Masukkan Kategori">
