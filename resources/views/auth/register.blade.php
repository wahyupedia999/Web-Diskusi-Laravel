            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Mini Forum</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Adventure starts here 🚀</h4>
              <p class="mb-4">Sign Up before you use the application</p>
              ...
              <form class="mb-3" action="{{ route('register') }}" method="POST">
                ...
                <div class="row mb-2">
                  <label for="ttl" class="col-sm-4 col-form-label">{{ __('Tempat Tanggal Lahir') }}</label>
                  <div class="col-sm-8">
                    <input 
                      id="ttl" 
                      type="date" 
              ...
              <div class="row mb-2">
                  <label for="ttl" class="col-sm-4 form-label">{{ __('Jenis Kelamin') }}</label>
                  <div class="col-sm-8">
                ...
                <div class="row mb-2">
                  <label for="ttl" class="col-sm-4 form-label">{{ __('Alamat') }}</label>
                  <div class="col-sm-8">
                ...
                <div class="row mb-2">
                  <label for="pekerjaan" class="col-sm-4 form-label">{{ __('Pekerjaan') }}</label>
                  <div class="col-sm-8">
                ...
                <div class="row mb-2">
                  <label for="email" class="col-sm-4 form-label">{{ __('Email Address') }}</label>
                  <div class="col-sm-8">
                ...
                <div class="row mb-2 form-password-toggle">
                   <label for="password" class="col-sm-4 form-label">{{ __('Password') }}</label>
                   <div class="col-sm-8">
                  ...
                  <div class="row mb-4 form-password-toggle">
                    <label for="password-confirm" class="col-sm-4 form-label">{{ __('Confirm Password') }}</label>
                    <div class="col-sm-8">
                    <div class="input-group input-group-merge">
